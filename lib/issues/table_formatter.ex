defmodule Issues.TableFormatter do
    ...
    @doc """
        ...
        data from each row identifier by each header. That is,
        each header identifies a column, and those columns are 
        extracted and printed from the rows. We calculate
        the width of each column to fit the longest element
    """
    ...
    @doc """
        ...
        of columns, return a lost containing lists of the data in
    ...
    @doc """
        ...
        hypehs, with + signs where the vertical bar between the columns gows.
    ...
    @doc """
        Given s list containing rows of data, a list containing the header selectors,
        and a format string, write the extracted data undercontrol of the format string
    """
